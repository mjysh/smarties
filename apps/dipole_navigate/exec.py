...
from NavigationEgo2sensor_env import *
...
def setupSmartiesCommon(comm):
    ...
    env = DipoleSingleEnv(mode=mode,dt = dt,mu=mu,alpha = alpha, flexibility = fishflex,cfd_dumpinterval=5,cfd_framerate = 1000,cfd_inittime = 160)
