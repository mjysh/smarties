...
from NoRotEgoTwoSensor_env import *
...
def setupSmartiesCommon(comm):
    ...
    env = DipoleSingleEnv(mode=mode,dt = dt,mu=mu,alpha = alpha, flexibility = fishflex,cfd_readinterval=5,cfd_framerate = 1000,cfd_inittime = 150)
