...
class DipoleSingleEnv(gym.Env):
    ...
    def __init__(self, mode = 'CFD', dt = 0.1, alpha = 3, r = 3,mu = 0.8, flexibility = 0.5, train_offset=0.1,cfdpath='/home/yusheng/newCFD/',cfd_readinterval=5,cfd_framerate = 1000,cfd_inittime = 150):
        # size and parameters
        self.speed = mu
        self.bl = 1
        self.bw = 0.2
